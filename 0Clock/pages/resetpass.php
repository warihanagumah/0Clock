...
<head>
    ...
    <title>zerOClock - Reset Password</title>
</head>
...
<body>
    ...
    <section>    
        ...
        <label>New Password</label>
            <input style="color:black;" name="password" type="password" tabindex="2" required >
            </fieldset>
          <button name="resetpass" type="submit" id="contact-submit">Reset Password</button>
        </fieldset>
        <fieldset>
