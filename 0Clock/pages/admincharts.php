                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                          <div class="row">
                                              ...
                                              ?>
                                              <div style="margin-right:600px;" class="form-container"> 
                                              <div id="piechart"></div>
                                              <div id="barchart"></div>
                                                ...
                                                function drawChart() {
                                                  ...
                                                  ['Task', 'Comaprism of Bookings to feedback'],
                                                  ['#BOOKINGS', <?php 
                                              ...
                                              $numfeedback = $statement->fetchColumn();;         
                                                echo $numfeedback;?>]
                                                ]);

                                                  // Optional; add a title and set the width and height of the chart
                                                  var options = {'title':'Pie chart showing the percentage of bookings and feedback', 'width':1000, 'height':600};
                                                  ...
                                                  // Optional; add a title and set the width and height of the chart
                                                  var options = {'title':'Barchart chart showing comparism of bookings and feedback', 'width':1000, 'height':600};
