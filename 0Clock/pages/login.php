...
<section>    
    ...
    <h3>Login</h3>
    <p name="error" styele="color:red"></p>
    <fieldset>
        <label>Email</label>
        <input name="email" type="email" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
    ...
    <fieldset>
        <a href="resetpassworddetails.php"> Forget your password?</a>
    </fieldset>    
    ...
    <fieldset>
      <p style="font-weight: bold;"> New to 0Clock? <a href="register.php"> Sign up now</a></p>
    </fieldset>
    <fieldset>
      <p style="font-weight: bold;"> Back to <a href="../index.php"> Home</a></p>
    </fieldset>
